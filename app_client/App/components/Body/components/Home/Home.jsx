      ...
      <div className="container-fluid">
          ...
          <div className="row firstRow">
            ...
            <div className="col-md-4 info">
                ...
                <p>Cadre is a unique way to create websites that have your own flair! Whether you want a simple website to advertise your business,
                    or if you want to manage your own data and users, Cadre can help you achieve your goals in only a few easy steps.</p>
              </div>
