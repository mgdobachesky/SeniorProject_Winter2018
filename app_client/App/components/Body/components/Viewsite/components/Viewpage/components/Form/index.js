...
class Form extends React.Component {
  ...
  handleCreateFormTextInput(event) {
    ...
    this.manageFormTextInputService.createFormTextInput(requestData)
    .then((results) => {
      ...
      this.setState({
        formTextInputError: error.response.data
      });
    });
  }
  ...
  handleEditFormTextInput(event) {
    ...
    this.setState({
      formTextInput: editFormTextInput
    });
  ...
  handleUpdateFormTextInput(event) {
    ...
    this.manageFormTextInputService.updateFormTextInput(requestData)
    .then((results) => {
      // Follow up by clearing form state
      this.handleClearFormTextInput();
  ...
  handleDeleteFormTextInput(event) {
    ...
    this.manageFormTextInputService.deleteFormTextInput(requestData)
    .then((results) => {
      this.handleReadAllFormTextInputs();
    }, (error) => {
      this.setState({
  ...
  handleClearFormTextInput() {
    ...
    this.setState({
      formTextInput: clearFormTextInput
    });
  }
  ...
  componentDidMount() {
    ...
    this.setState({
      formTextInput: currentFormTextInput
    });
